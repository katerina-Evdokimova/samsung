...
/**
 ...
 режиме игры, как только игрок съест 4 последовательных блюда, дверь выхода (белый квадрат). В данном меню
 игрок сможет оставить отзывы и предложения, а также увидеть список своих игр.
 */
